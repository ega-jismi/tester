    ...
    <div className="min-h-screen flex bg-white dark:bg-slate-900">
      ...
      <div className="hidden md:flex w-1/2 bg-slate-800 relative overflow-hidden">
        <div
          ...
          style={{
            backgroundImage:
              "url('https://images.unsplash.com/photo-1481627834876-b7833e8f5570?q=80&w=2228&auto=format&fit=crop')",
      ...
      <div className="max-w-md w-full py-10">
          <div className="text-center mb-8">
            <img
              ...
              alt="Paper Bloom"
              className="h-100 mx-auto mb-20 dark:hidden"
            />
            <img
              src="/images/logo-putih.png"
              alt="Paper Bloom"
              className="h-100 mx-auto mb-20 hidden dark:block"
            />
            ...
            <p className="text-slate-500 dark:text-slate-400 mt-2 text-sm">
              {isLoginMode
                ...
                : "Isi data diri untuk mulai berbelanja."}
            </p>
          </div>
                ...
                >
                  ...
                  <div className="relative">
                    ...
                    <input
                      ...
                      className="w-full pl-10 pr-4 py-3 rounded-xl border border-slate-200 dark:border-slate-700 bg-slate-50 dark:bg-slate-800 text-slate-900 dark:text-white focus:ring-2 focus:ring-bookBlue outline-none transition-all"
              ...
              <div className="flex justify-between">
                ...
                {isLoginMode && (
                  <Link
                    ...
                    className="text-xs text-bookBlue hover:underline"
                  >
                    Lupa Password?
                  </Link>
                )}
          ...
          <div className="grid grid-cols-2 gap-4">
            <button
              className="flex items-center justify-center gap-2 py-2.5 border border-slate-200 dark:border-slate-700 rounded-xl hover:bg-slate-50 dark:hover:bg-slate-800 transition-colors text-sm font-medium text-slate-700 dark:text-slate-300"
              onClick={async () =>
            ...
            >
              <FiChrome className="text-red-500" /> Google
            </button>
            <button
              className="flex items-center justify-center gap-2 py-2.5 border border-slate-200 dark:border-slate-700 rounded-xl hover:bg-slate-50 dark:hover:bg-slate-800 transition-colors text-sm font-medium text-slate-700 dark:text-slate-300"
              onClick={async () =>
